...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        filtered_df = filtered_df.groupby('Launch Site')['class'].mean()
        fig = px.pie(values=filtered_df, 
        names=spacex_df.groupby('Launch Site')['Launch Site'].first(), 
        title='Total Success Launches by Site')
    else:
        filtered_df = filtered_df[filtered_df['Launch Site']==str(entered_site)]['class'].value_counts(normalize=True)
        fig = px.pie(values=filtered_df,
